...
namespace YifyLib.Api
{
    ...
    {
        public static XDocument LoadXDoc(string response)
        {
        ...
        public static Movie ParseGetMovieResponse(string res)
        {
            XDocument doc = LoadXDoc(res);
        ...
        public static List<Comment> ParseGetMovieCommentsResponse(string res)
        {
            XDocument doc = LoadXDoc(res);
        ...
        public static List<Review> ParseGetMovieReviewResponse(string res)
        {
            XDocument doc = LoadXDoc(res);
        ...
        public static List<ParentalGuide> ParseGetMovieParentalGuideResponse(string res)
        {
            XDocument doc = LoadXDoc(res);
        ...
        public static User ParseGetUserDetailsResponse(string res)
        {
            XDocument doc = LoadXDoc(res);
        ...
        public static string ParseGetUserKeyResponse(string res)
        {
            XDocument doc = LoadXDoc(res);
            var xnodes = doc.GetXElement("data");
            return xnodes.GetXDecendentValue<string>("user_key");
        }
        public static Profile ParseGetProfileRequest(string res)
        {
            XDocument doc = LoadXDoc(res);
            var xnodes = doc.GetXElement("data");
        ...
        public static RegisterUser ParseRegisterUserResponse(string res)
        {
            XDocument doc = LoadXDoc(res);
            var xnodes = doc.GetXElement("data");
        ...
        public static List<BookmarkedMovie> ParseGetBookmarkedMoviesResponse(string res)
        {
            XDocument doc = LoadXDoc(res);
            var xmovies = doc.GetXElement("data").GetXElements("movie").ToList();
        ...
        public static int ParseMakeCommentResponse(string res)
        {
            XDocument doc = LoadXDoc(res);
